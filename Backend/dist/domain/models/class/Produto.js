...
class Produto {
     ...
     */
    constructor(_id, _nome, _descricao, _preco, _categoria, _imagemUrl, _disponivel) {
        this._id = _id;
        this._nome = _nome;
        this._descricao = _descricao;
        this._preco = _preco;
        this._categoria = _categoria;
        this._imagemUrl = _imagemUrl;
    ...
    static fromPersistence(data) {
        return new Produto(data.id, data.nome, data.descricao, data.preco, data.categoria, data.imagemUrl, data.disponivel);
    }
    /**
