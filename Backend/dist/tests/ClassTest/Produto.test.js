...
describe('Produto', () => {
    describe('Criação e Validação', () => {
        it('deve criar produto válido', () => {
            const produto = new Produto_1.Produto('1', 'Bolo de Chocolate', 'Bolo a base de chocolate', 25, 'bolos', 'img.jpg', true);
        ...
        it('deve lançar erro com nome vazio', () => {
            expect(() => new Produto_1.Produto('1', '', 'Desc', 100, 'teste', null, true)).toThrow('Nome do produto é obrigatório');
        });
        it('deve lançar erro com preço inválido', () => {
            expect(() => new Produto_1.Produto('1', 'Produto', 'Desc', 0, 'teste', null, true)).toThrow('Preço inválido');
            expect(() => new Produto_1.Produto('1', 'Produto', 'Desc', -10, 'teste', null, true)).toThrow('Preço inválido');
        });
    });
    describe('alterarNome', () => {
        it('deve alterar nome com sucesso', () => {
            const produto = new Produto_1.Produto('1', 'Nome Antigo', 'Desc', 100, 'teste', null, true);
            produto.alterarNome('Nome Novo');
            expect(produto.nome).toBe('Nome Novo');
        });
        it('deve lançar erro com nome vazio', () => {
            const produto = new Produto_1.Produto('1', 'Nome', 'Desc', 100, 'teste', null, true);
            expect(() => produto.alterarNome('')).toThrow('Nome inválido');
        });
    });
    describe('alterarPreco', () => {
        it('deve alterar preço com sucesso', () => {
            const produto = new Produto_1.Produto('1', 'Produto', 'Desc', 100, 'teste', null, true);
    ...
    describe('atualizar', () => {
        ...
        it('deve atualizar apenas campos fornecidos', () => {
            const produto = new Produto_1.Produto('1', 'Nome', 'Desc', 100, 'teste', 'img.jpg', true);
