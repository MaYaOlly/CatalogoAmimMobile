...
describe('ProdutoService', () => {
    ...
    beforeEach(() => {
        ...
        produtoService = new ProdutoService_1.ProdutoService(mockProdutoRepository);
    });
    describe('listarProdutosDisponiveis', () => {
        it('deve retornar apenas produtos disponíveis', async () => {
            const disponivel1 = new Produto_1.Produto('1', 'Produto 1', 'Desc', 100, 'Cat', null, true);
            const indisponivel = new Produto_1.Produto('2', 'Produto 2', 'Desc', 200, 'Cat', null, false);
            const disponivel2 = new Produto_1.Produto('3', 'Produto 3', 'Desc', 150, 'Cat', null, true);
    ...
    describe('buscarProdutoPorId', () => {
        it('deve retornar produto quando encontrado', async () => {
            const produto = new Produto_1.Produto('1', 'Produto', 'Desc', 100, 'Cat', null, true);
    ...
    describe('atualizarProduto', () => {
        it('deve atualizar produto com sucesso', async () => {
            const produto = new Produto_1.Produto('1', 'Nome Antigo', 'Desc Antiga', 100, 'Cat', null, true);
            mockProdutoRepository.buscarPorId.mockResolvedValue(produto);
            mockProdutoRepository.atualizar.mockImplementation((id, p) => Promise.resolve(p));
