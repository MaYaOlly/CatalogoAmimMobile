...
const ProdutoController_1 = require("../../infrastructure/http/controllers/ProdutoController");
...
describe('ProdutoController', () => {
    ...
    beforeEach(() => {
        ...
        produtoController = new ProdutoController_1.ProdutoController(mockProdutoService);
        mockReply = {
    ...
    describe('listar', () => {
        it('deve listar produtos disponíveis', async () => {
            const produtos = [
                new Produto_1.Produto('1', 'Notebook', 'Desc', 2500, 'Eletrônicos', null, true),
                new Produto_1.Produto('2', 'Mouse', 'Desc', 50, 'Periféricos', null, true),
            ];
            mockRequest = {};
            mockProdutoService.listarProdutos.mockResolvedValue(produtos);
            await produtoController.listar(mockRequest, mockReply);
    ...
    describe('buscarPorId', () => {
        it('deve buscar produto por id', async () => {
            const produto = new Produto_1.Produto('1', 'Notebook', 'Desc', 2500, 'Eletrônicos', null, true);
            mockRequest = { params: { id: '1' } };
            mockProdutoService.buscarProdutoPorId.mockResolvedValue(produto);
            await produtoController.buscarPorId(mockRequest, mockReply);
    ...
    describe('criar', () => {
        it('deve criar produto com sucesso', async () => {
            const produto = new Produto_1.Produto('1', 'Notebook', 'Notebook Dell', 2500, 'Eletrônicos', 'img.jpg', true);
            mockRequest = {
                body: {
                    nome: 'Notebook',
            ...
            await produtoController.criar(mockRequest, mockReply);
    ...
    describe('atualizar', () => {
        it('deve atualizar produto com sucesso', async () => {
            const produto = new Produto_1.Produto('1', 'Notebook Novo', 'Desc', 3000, 'Eletrônicos', null, true);
            mockRequest = { params: { id: '1' }, body: { nome: 'Notebook Novo', preco: 3000 } };
            mockProdutoService.atualizarProduto.mockResolvedValue(produto);
            await produtoController.atualizar(mockRequest, mockReply);
    ...
    describe('deletar', () => {
        it('deve deletar produto com sucesso', async () => {
            ...
            await produtoController.deletar(mockRequest, mockReply);
